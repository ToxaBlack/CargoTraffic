...
INSERT INTO `vehicle` (`license_plate`, `products_constraint`, `fuel_consumption`, `company_id`, `vehicle_type_id`, `vehicle_fuel_id`, `deleted`) VALUES
  ("1234-AB", 1234.3, 15.3, 1, 2, 3, 0),
  ("6543-QW", 2345.6, 20.5, 1, 2, 1, 0),
  ("4567-RT", 3456.75, 17.8, 2, 3, 4, 0);
